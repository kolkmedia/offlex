...
return [
  ...
  'description' => 'Offlex ist eine kostenlose, Open-Source Lösung für die Rechnungsstellung und Abrechnung deiner Kunden. With Offlex, you can easily build and send beautiful invoices from any device that has access to the web. Your clients can print your invoices, download them as pdf files, and even pay you online from within the system.',
  ...
  'about' => [
    'header' => '<span class="thin">Über</span> Offlex',
    'what_is' => 'Was ist Offlex?',

    'team_offlex' => 'Team Offlex',
    'team_offlex_text' => 'Offlex is managed by a team of seasoned web workers. We launched in early 2014 and have been thrilled by the enthusiastic response we’ve received from our growing community of users.',
  ...
  'features' => [
    ...
    'open_source_text1' => 'Set the code free! Here at Offlex, we’re all about creating the best possible app, and inviting scrutiny via full code transparency is a central manifestation of this value.',
    'open_source_text2' => 'We firmly believe that being an open source product helps everyone involved. We’re looking forward to seeing what the developers out there can do to take Offlex into new realms of usefulness.',
    ...
    'free_forever_text2' => 'Teste Offlex. Du hast buchstäblich nichts zu verlieren. Wir sind uns sicher, deine Erfahrung wird so positiv sein, dass du nie wieder einen anderen Service brauchen wirst.',

    'secure' => 'Sicher & Privat',
    'secure_text1' => 'Offlex  wurde von Grund auf entworfen, um Ihre Daten sicher zu halten. Nur du hast Zugriff auf deine Anmeldungs-und Buchaltungsdaten und wir werden deine Transaktionen niemals an dritte weitergeben.',
    'secure_text2' => 'Unsere Webseite benutzt 256-bit verschlüsselung, das ist sicherer, als die meisten Online-Banking-Seiten! Offlex benutzt das  kryptographische Protokoll TLS 1.0, AES_256_CBC string encryption, SHA1 message authentication and DHE_RSA key exchanges. Wir fühlen uns hier sicher und haben masiv darin investiert, dass es dir genauso geht.',

    'live_pdf' => 'Live .PDF Vorschau',
    'live_pdf_text1' => 'With Offlex, we’ve done away with the need for cumbersome multi-click invoice previewing after each save.',
    ...
    'online_payments' => 'Online Bezahlungen',
    'online_payments_text1' => 'Offlex seamlessly integrates with all of the top internet payment processors and gateways so you can get paid for your work quickly and easily.',
  ...
  'plans' => [
    ...
    'go_pro' => 'Go Pro to Unlock Premium Offlex Features',
    'go_pro_text' => 'We believe that the free version of Offlex is a truly awesome product loaded with the key features you need to bill your clients electronically. But for those who crave still more Offlex awesomeness, we\'ve unmasked the Offlex Pro plan, which offers more versatility, power and customization options for just $50 per year.',
    ...
    'remove_created_by' => 'Remove "Created by Offlex"',
  ...
  'testimonials' => [
    ...
    'header' => 'Since we launched Offlex in March of 2014, we\'ve been overwhelmed by a deluge of user love. Here\'s a small taste of the glowing things people have to say about the great experiences the\'ve been having with our free e-invoicing app!',
  ],

  'faq' => [
    'header' => '<span class="thin">Das</span> FAQ',

    'question1' => 'I know it isn’t standard offlex practice to reveal too many identity details, but who are you guys exactly?',
    'answer1' => 'We’re a small team of highly skilled digital journeymen based in Israel. We love open source, we love disrupting the big business status quo, and we love building helpful tools that are easy to use. We believe that everyone else’s web-based cash flow tools are unnecessarily expensive, clunky and complicated - and we’re bent on proving these beliefs with Offlex.',

    'question2' => 'How do I get started using Offlex?',
    'answer2' => 'Just click on the big, yellow "Invoice Now" button on our homepage!',

    'question3' => 'Do you offer customer support?',
    'answer3' => 'We sure do. Support is super important to us. Feel free to email us at <a href="mailto:support@offlex.com">support@offlex.com</a> with any questions you might have. We almost always reply within one business day.',

    'question4' => 'Ist Offlex wirklich kostenlos? Für wie lange?',
    'answer4' => 'Yes, our basic app is 100% free. Forever and ever. For real. We also offer a paid Pro version of Offlex (you can learn all about its awesome features <a href="https://www.offlex.com/plans">here</a>), but it\'s important to us that the free version have all of the key features people need to do business.',

    'question5' => 'How is Offlex able to offer this all for free? How are you making any money?',
    'answer5' => 'We’re mostly in this line of work because we believe it’s high time that a good electronic invoicing tool be available for free. There isn’t much money in it - yet. We do offer a paid <a href="https://www.offlex.com/plans">Pro </a> version of the app that we\'ve souped up with premium features. And when our users open up new accounts with payment processor gateways by clicking on links from our site, we make modest commissions as a gateway affiliate. So if zillions of freelancers and small businesses start running credit card charges through Offlex, or if scores of users go <a href="https://www.offlex.com/plans">Pro</a>, there’s a decent chance we\'ll recover our investment.',
    ...
    'answer6' => 'No way. We’re not mining your data, and we’re not selling you out. That wouldn’t be very offlex of us, would it?',

    'question7' => 'But don’t you have access to my merchant and banking accounts?',
    'answer7' => 'Actually, we don’t. When you link an account at a third party financial institution with your Offlex account, you’re essentially giving our app permission to send money to you and nothing more. This is all managed by the tech teams at your financial service providers, who go to great lengths to ensure their integrations can’t be exploited or abused.',

    'question8' => 'Given that Offlex is an open source app, how can I be sure that my financial information is safe with you?',
    'answer8' => 'There\'s a big difference between “open source" and “open data.” Anyone who wants to use the code that drives Offlex to create their own products or to make improvements to ours can do so. It’s available for anyone who wants to download and work with. But that’s just the source code - totally separate from what happens with that code on the Offlex servers. You’re the only one who has full access to what you\'re doing with our product. For more details on the security of our servers and how we handle our users\' information, please read the next question.',
    ...
    'question10' => 'How do I remove the small "Created by Offlex” image from the bottom of my invoices?',
    'answer10' => 'The amazingly affordable <a href="https://www.offlex.com/plans">Pro</a> version of Offlex allows you to do this and oh so much more.',
    ...
    'answer14' => 'Please email us at <a href="mailto:contact@offlex.com">contact@offlex.com</a> with any questions or comments you have. We love hearing from the people who use our app! We’ll do our best to reply to your email within the business day.',

    'miss_something' => 'Haben wir etwas vergessen?',
    'miss_something_text' => 'Schreib uns eine E-Mail an <a href="mailto:contact@offlex.com" style="font-weight: bold">contact@offlex.com</a> mit jeder Frage und jedem Kommentar, den du uns gerne mitteilen möchtest. Wir lieben es von den Menschen zu hören, die unsere Angebot nutzen! Wir werden unser bestes geben, um deine E-Mail innerhalb eines Werktages zu beantworten.',
