!function ($) {
    "use strict";
    var Offlex = function () {
        this.VERSION = "1.0.0", this.AUTHOR = "Offlex", this.SUPPORT = "support@offlex.nl", this.pageScrollElement = "html, body", this.$body = $("body"), this.setUserOS(), this.setUserAgent()
    };
    Offlex.prototype.setUserOS = function () {
        var OSName = "";
    ...
    }, Offlex.prototype.setUserAgent = function () {
    ...
    }, Offlex.prototype.getColor = function (color, opacity) {
        ...
        return rgba
    }, Offlex.prototype.initDropDown = function () {
    ...
    }, Offlex.prototype.initFormGroupDefault = function () {
    ...
    }, Offlex.prototype.initSlidingTabs = function () {
    ...
    }, Offlex.prototype.initNotificationCenter = function () {
    ...
    }, Offlex.prototype.initTooltipPlugin = function () {
        $.fn.tooltip && $('[data-toggle="tooltip"]').tooltip()
    }, Offlex.prototype.initSelect2Plugin = function () {
    ...
    }, Offlex.prototype.init = function () {
    ...
    }, $.Offlex = new Offlex, $.Offlex.Constructor = Offlex
    ...
    var Sidebar = function (element, options) {
        function sidebarMouseEnter() {
            return $.Offlex.isVisibleSm() || $.Offlex.isVisibleXs() ? !1 : void($(".close-sidebar").data("clicked") || _this.$body.hasClass("menu-pin") || (_this.cssAnimation ? (_this.$element.css({transform: _this.menuOpenCSS}), _this.$body.addClass("sidebar-visible")) : _this.$element.stop().animate({left: "0px"}, 400, $.bez(_this.bezierEasing), function () {
                _this.$body.addClass("sidebar-visible")
            })))
        }

        function sidebarMouseLeave(e) {
            if ($.Offlex.isVisibleSm() || $.Offlex.isVisibleXs())return !1;
