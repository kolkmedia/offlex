        ...
        <div class="modal-content">
            ...
            <center id="designThumbs">
                ...
                <a href="{{ asset('/images/designs/business.png') }}" data-lightbox="more-designs"
                   data-title="Business"><img src="{{ asset('/images/designs/business_thumb.png') }}"/></a>&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="{{ asset('/images/designs/creative.png') }}" data-lightbox="more-designs"
                   data-title="Creative"><img src="{{ asset('/images/designs/creative_thumb.png') }}"/></a>&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="{{ asset('/images/designs/elegant.png') }}" data-lightbox="more-designs"
                   data-title="Elegant"><img src="{{ asset('/images/designs/elegant_thumb.png') }}"/></a>

                <p>&nbsp;</p>
                <a href="{{ asset('/images/designs/hipster.png') }}" data-lightbox="more-designs"
                   data-title="Hipster"><img src="{{ asset('/images/designs/hipster_thumb.png') }}"/></a>&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="{{ asset('/images/designs/playful.png') }}" data-lightbox="more-designs"
                   data-title="Playful"><img src="{{ asset('/images/designs/playful_thumb.png') }}"/></a>&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="{{ asset('/images/designs/photo.png') }}" data-lightbox="more-designs" data-title="Photo"><img
                            src="{{ asset('/images/designs/photo_thumb.png') }}"/></a>
            ...
            <div class="modal-footer" id="signUpFooter">
                ...
                @if (Utils::isOfflexProd())
                    <button type="button" class="btn btn-primary"
                            onclick="showProPlan('invoice_designs')">{{ trans('texts.go_pro') }}</button>
                @else
                    <button type="button" class="btn btn-primary"
...
<script type="text/javascript">
    ...
    logoImages.imageLogo1 = "{{ HTML::image_data('logo/offlex_large.png') }}";
    logoImages.imageLogoWidth1 = 120;
    logoImages.imageLogoHeight1 = 40

    logoImages.imageLogo2 = "{{ HTML::image_data('logo/offlex_large.png') }}";
    logoImages.imageLogoWidth2 = 325 / 2;
    logoImages.imageLogoHeight2 = 81 / 2;

    logoImages.imageLogo3 = "{{ HTML::image_data('logo/offlex_large.png') }}";
    ...
    var OFFLEX = OFFLEX || {};
    OFFLEX.primaryColor = "{{ $account->primary_color }}";
    OFFLEX.secondaryColor = "{{ $account->secondary_color }}";

    @if(Auth::user())
        OFFLEX.fontSize = {{Auth::user()->account->font_size}};
    @else
        OFFLEX.fontSize = {{DEFAULT_FONT_SIZE}};
    @endif
