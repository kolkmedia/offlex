...
return [
  ...
  'description' => 'Offlex is a free, open-source solution for invoicing and billing customers. With Offlex, you can easily build and send beautiful invoices from any device that has access to the web. Your clients can print your invoices, download them as pdf files, and even pay you online from within the system.',
  ...
  'about' => [
    'header' => '<span class="thin">About</span> Offlex',
    'what_is' => 'What is Offlex?',
  ...
  'features' => [
    ...
    'free_forever_text2' => 'Try Offlex out. You literally have nothing to lose. We’re confident that you’ll find the experience so positive that you’ll never need to turn elsewhere.',

    'secure' => 'Secure & Private',
    'secure_text1' => 'Offlex has been built from the ground up to keep your data safe. Only you have access to your login & accounting details, & we will never share your transaction data to any third party.',
    'secure_text2' => 'Our website operates with 256-bit encryption, which is even more secure than most banking websites. Offlex uses the TLS 1.0 cryptographic protocol, AES_256_CBC string encryption, SHA1 message authentication and DHE_RSA key exchanges. We feel safe here and have invested heavily in measures to ensure that you do too.',
  ...
  'faq' => [
    ...
    'question4' => 'Is Offlex really free? For how long?',
    ...
    'miss_something_text' => 'Please email us at <a href="mailto:contact@offlex.com" style="font-weight: bold">contact@offlex.com</a> with any questions or comments you have. We love hearing from the people who use our app! We’ll do our best to reply to your email within the business day.',
