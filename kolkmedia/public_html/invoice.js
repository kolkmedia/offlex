var GlobalY=0;
//Y position of line at current page
//main offlex design --
...
//doc.addFont('DroidSans', 'Droid Sans', 'normal');
//doc.setFont('Droid Sans');
...
displayAccount(doc, invoice, 430, layout.accountTop, layout);
...
var invoiceHeight = displayInvoice(doc, invoice, 350, 150, layout);
var clientHeight = displayClient(doc, invoice, 50, 150, layout);
