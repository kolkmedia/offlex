...
@section('content')
    ...
    <form class="form-inline" role="form">
        Group By &nbsp;&nbsp;
        <select id="groupBySelect" class="form-control normal-form-control" onchange="update()">
    ...
    <p>&nbsp;</p>
    <div class="svg-div"/>
    <div class="pgn-wrapper hidden" data-position="right" id="tooltip">
        <div class="pgn pgn-simple col-md-12">
            <div class="alert alert-info">
                <strong><span id="tooltipTitle"></span></strong>
                </br>
                </br>
                {{trans('texts.total')}} <span id="tooltipTotal" class="pull-right"></span></br>
                {{trans('texts.balance')}} <span id="tooltipBalance" class="pull-right"></span></br>
                {{trans('texts.age')}} <span id="tooltipAge" class="pull-right"></span>
                </br>
                </br>
                <a class="pull-right" href="#" target="_blank">{{trans('texts.view_client')}}</a>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        function update() {
            ...
            node.on("mousemove", function (d) {
                ...
                console.log('d3', d3.select(this).attr('d'));
