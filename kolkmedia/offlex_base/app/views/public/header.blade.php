    ...
    <div class="container">
        <div class="navbar-header">
            ...
            @if (!isset($hideLogo) || !$hideLogo)
                ...
                <a class="navbar-brand" href="https://www.kolkmedia.com/"><img src="{{ asset('images/kolkmedia-logo.png') }}"></a>
            @endif            
        </div>
            ...
            <div id="footer-menu" class="menu-wrap">
                <ul id="menu-footer-menu" class="menu">
                    ...
                    <li id="menu-item-31" class="menu-item-31">                    
                        {{ link_to('#', 'Facebook', ['target' => '_blank', 'onclick' => 'openUrl("https://www.facebook.com/kolkmedia", "/footer/social/facebook")']) }}
                    </li>
                    <li id="menu-item-32" class="menu-item-32">
                        {{ link_to('#', 'Twitter', ['target' => '_blank', 'onclick' => 'openUrl("https://twitter.com/kolkmedia", "/footer/social/twitter")']) }}
                    </li>
                    <li id="menu-item-33" class="menu-item-33">
                        {{ link_to('#', 'GitHub', ['target' => '_blank', 'onclick' => 'openUrl("https://github.com/kolkmedia/offlex", "/footer/social/github")']) }}
                    </li>                    
                </ul>
            </div>      
            @endif   
