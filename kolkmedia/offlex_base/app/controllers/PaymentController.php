...
use offlex\repositories\PaymentRepository;
...
//        echo ('test');
    ...
    public function show_license_payment()
    {
        ...
        if (Utils::isOfflexDev() && Input::has('test_mode')) {
            Session::set('test_mode', Input::get('test_mode'));
        }

        $account = $this->accountRepo->getOfflexAccount();
    ...
    private function createPayment($invitation, $ref, $payerId = null)
    {
        ...
        if ($invoice->account->account_key == OFFLEX_ACCOUNT_KEY) {
