    ...
    $(document).ready(function() {
        ...
        (function() {
            ...
            var graph = new Rickshaw.Graph({
                ...
                series: [{
                    data: seriesData[0],
                    color: $.Offlex.getColor('success-light', .5),
                    name: 'DB Server'
                }, {
                    data: seriesData[1],
                    color: $.Offlex.getColor('master-light'),
                    name: 'Web Server'
                }]
            });
        ...
        d3.json('http://www.offlex.dev/template/data/min_sales_chart.json', function(data) {
        
        	$.getJSON("../data/min_sales_chart.json", function(json) {
        ...
        $('.widget-13-map').mapplic({
            source: 'http://www.offlex.dev/template/data/dashboard-map.json',
            height: 465,
            sidebar: false,
            minimap: false,
            locations: true,
        ...
        //NVD3 Charts
        d3.json('http://www.offlex.dev/template/data/charts.json', function(data) {
            ...
            (function() {
                nv.addGraph(function() {
                    var chart = nv.models.lineChart()
                        ...
                        .color([
                            $.Offlex.getColor('success'),
                            $.Offlex.getColor('danger'),
                            $.Offlex.getColor('primary'),
                            $.Offlex.getColor('complete'),
            ...
            (function() {
                ...
                var graph = new Rickshaw.Graph({
                    ...
                    series: [{
                        data: seriesData[0],
                        color: $.Offlex.getColor('complete-light'),
                        name: "New users"
                    }, {
                        data: seriesData[1],
                        color: $.Offlex.getColor('master-lighter'),
