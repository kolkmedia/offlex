...
return array(
  ...
  'deleted_credits' => ':count crédits supprimés avec succès',
    ...
    // Emails
  'confirmation_subject' => 'Validation du compte Offlex',
  ...
  // Pro Plan
  'pro_plan' => [
    'remove_logo' => ':link pour supprimer le logo Offlex en souscrivant au plan pro',
    'remove_logo_link' => 'Cliquez ici',
  ],

  'logout' => 'Se déconnecter',    
  'sign_up_to_save' => 'Connectez vous pour sauvegarder votre travail',  
  'agree_to_terms' =>'J\'accepte les conditions d\'utilisation d\'Invoice offlex :terms',
  ...
  'pro_plan_description' => 'Inscription d\'une durée d\'un an au Plan Pro d\'Offlex',
  ...
  'offlex_email_footer' => 'Utilisez :site pour facturer vos clients et être payés en ligne gratuitement!',
  ...
  'white_label_text' => 'Pour retirer la marque Offlex en haut de la page client, achetez un licence en marque blanche de '.WHITE_LABEL_PRICE.'$.',
