...
return array(
   ...
   // Emails
   'confirmation_subject' => 'Corfimación de tu cuenta en Offlex',
   ...
   'email_from' => 'El equipo de Offlex ',
   ...
   // Pro Plan
   'pro_plan' => [
   'remove_logo' => ':link haz click para eliminar el logo de Offlex', //Maybe incorrect for the context
   'remove_logo_link' => 'Haz clic aquí',
   ],
   'logout' => 'Cerrar sesión',   
   'sign_up_to_save' => 'Registrate para guardar tu trabajo', 
   'agree_to_terms' =>'Estoy de acuerdo con los términos de Offlex :terms',
   ...
   'pro_plan_description' => 'Un año de inscripción en el Plan Pro de Offlex.',
   'pro_plan_success' => '¡Gracias por unirte a Offlex! Al realizar el pago de tu factura, se iniciara tu PLAN PRO.',
   ...
   'offlex_email_footer' => 'Usa :site para facturar a tus clientes y recibir pagos de forma gratuita!',
   'go_pro' => 'Hazte Pro',
   ...
   'invitation_message' => ':invitor te ha invitado a unirte a su cuenta en Offlex.',
   ...
   'white_label_text' => 'Purchase a white label license for $'.WHITE_LABEL_PRICE.' to remove the Offlex branding from the top of the client pages.',
