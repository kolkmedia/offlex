...
@section('content')
    ...
    <legend style="padding-bottom:32px">
        ...
        <div class="pull-right">
           {{ Button::btn_info_link(URL::to('company/advanced_settings/data_visualizations'), trans("texts.data_visualizations"))}}
        </div>
    </legend>
	...
	<div class="row">
		<div class="col-lg-4">
			...
			{{ Former::select('chart_type')->options($chartTypes, $chartType)->class('form-control normal-form-control') }}
			{{ Former::select('group_by')->options($dateTypes, $groupBy)->class('form-control normal-form-control') }}
			...
			@if (Auth::user()->isPro())
				{{ Former::actions( Button::btn_info_submit(trans("texts.data_generate")) ) }}
			@else
			<script>
			    $(function() {   
			...
			<div style="padding-bottom:8px">
				...
				<div style="vertical-align: middle">&nbsp;{{trans("texts.invoices")}}</div>
			</div>			
			<div style="padding-bottom:8px; clear:both">
				...
				<div style="vertical-align: middle">&nbsp;{{trans("texts.payments")}}</div>
			</div>
			<div style="clear:both">
				...
				<div style="vertical-align: middle">&nbsp;{{trans("texts.credits")}}</div>
			</div>
