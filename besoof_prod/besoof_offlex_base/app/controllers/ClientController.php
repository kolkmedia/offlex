...
class ClientController extends \BaseController
{
    ...
    public function getDatatable()
    {
        ...
        return Datatable::query($clients)
            ->addColumn('checkbox', function ($model) { return '<div class="checkbox table-checkbox"><input type="checkbox" name="ids[]" value="'.$model->public_id.'" '.Utils::getEntityRowClass($model).'><label for="ids[]"></label></label></div>'; })
